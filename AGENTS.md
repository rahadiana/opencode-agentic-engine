...
5. ✅ **Test Coverage** — 2314+ tests, c8 86.88% statements + CI coverage gate (P4)
...
node test/run.mjs   # 2314+ unit tests (mock, no LLM needed)
...
- **Code coverage tooling**: `npm run test:coverage` via c8 (86.88% stmts, 67.12% branches, 74.86% funcs).
